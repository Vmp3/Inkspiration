...
@DisplayName("EmailService - Testes com Mocks")
class EmailServiceMockTest {
    ...
    void deveEnviarEmailConfirmacaoAlteracaoSenhaComSucesso() {
        ...
        emailService.sendPasswordResetConfirmation(toEmail, userName);
    ...
    void deveEnviarTodosTiposEmailEmSequencia() {
        ...
        emailService.sendPasswordResetCode(toEmail, userName, code1);
        emailService.sendTwoFactorRecoveryCode(toEmail, userName, code2);
        emailService.sendEmailVerification(toEmail, userName, code3);
        emailService.sendPasswordResetConfirmation(toEmail, userName);
